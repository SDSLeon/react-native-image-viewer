...
var ImageViewer = /** @class */ (function (_super) {
     ...
     * props 有变化时执行
     */
    ImageViewer.prototype.init = function (nextProps, isUpdate) {
        var _this = this;
        ...
        var initialIndex = isUpdate ? this.state.currentShowIndex : nextProps.index || nextProps.initialIndex;
        ;
        this.setState({
            currentShowIndex: initialIndex,
            imageSizes: imageSizes
        }, function () {
            _this.loadedIndex.clear();
            // 立刻预加载要看的图
            _this.loadImage(initialIndex || 0);
            _this.jumpToCurrentImage();
            // // 显示动画
            react_native_1.Animated.timing(_this.fadeAnim, {
                toValue: 1,
